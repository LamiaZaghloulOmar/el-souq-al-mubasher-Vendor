    ...
    return Scaffold(
      ...
      body: true
        ...
        return GetBuilder<CouponController>(builder: (couponController) {
          return GetBuilder<CheckOut>(builder: (orderController) {
...
//todo
                  Container(
                    ...
                    child: !orderController.isLoading
                        ...
                        onPressed: () {
                          List<place_order_body.Cart> carts =
                          [];
                          for (int index = 0;
                          ...
                          index++) {
                            ...
                            carts.add(place_order_body.Cart(
                              cart.isCampaign
                                  ? null
                                  : cart.product.id,
                              cart.isCampaign
...
*/ /*
                          ...
                          orderController.placeOrder(
                              place_order_body.PlaceOrderBody(
                                cart: carts,
...
/*GetBuilder<LocationController>(builder: (locationController) {
  ...
  void _callback(
    ...
    if (isSuccess) {
      ...
      Get.find<CheckOut>().stopLoader();
      if (Get.find<CheckOut>().paymentMethodIndex == 0 ||
          Get.find<CheckOut>().paymentMethodIndex == 2) {
        // Get.offNamed(
...
/*   if (GetPlatform.isWeb) {
      ...
      Get.find<CheckOut>().clearPrevData();
