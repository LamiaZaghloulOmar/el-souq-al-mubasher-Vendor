...
import 'package:efood_multivendor_restaurant/view/screens/address/add_address_screen.dart';
...
import 'package:efood_multivendor_restaurant/view/screens/cart/cart_screen.dart';
import 'package:efood_multivendor_restaurant/view/screens/category/category_screen.dart';
import 'package:efood_multivendor_restaurant/view/screens/checkout/checkout_screen.dart';
...
import 'package:efood_multivendor_restaurant/view/screens/location/access_location_screen.dart';
import 'package:efood_multivendor_restaurant/view/screens/location/map_screen.dart';
import 'package:efood_multivendor_restaurant/view/screens/location/pick_map_screen.dart';
...
class RouteHelper {
  ...
  static String getAddProductRoute(
      Product productModel, List<Translation> translations) {
    ...
    GetPage(
        ...
        page: () {
          List<int> _decode =
              base64Decode(Get.parameters['data'].replaceAll(' ', '+'));
          Restaurant _data =
              Restaurant.fromJson(jsonDecode(utf8.decode(_decode)));
