...
import 'package:efood_multivendor_restaurant/controller/product_controller.dart';
...
import 'package:efood_multivendor_restaurant/data/repository/cart_repo.dart';
...
import 'package:efood_multivendor_restaurant/data/repository/location_repo.dart';
...
import 'package:efood_multivendor_restaurant/data/repository/product_repo.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(
      () => LocationRepo(sharedPreferences: Get.find(), apiClient: Get.find()));
  ...
  // Get.lazyPut(() => CheckOut(orderRepo: Get.find()));
