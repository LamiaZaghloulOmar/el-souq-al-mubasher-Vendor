...
import 'package:efood_multivendor_restaurant/view/screens/location/widget/permission_dialog.dart';
...
/*
              ...
              } else if (userController.profileModel != null &&
                  _contactPersonNameController.text.isEmpty) {
                _contactPersonNameController.text =
                    '${userController.profileModel.fName} ${userController.profileModel.lName}';
                _contactPersonNumberController.text =
                    userController.profileModel.phone;
              }
*/
                        ...
                        ? CustomButton(
                            ...
                            onPressed: locationController.loading
                                ...
                                : () {
                                    ...
                                    print(locationController.zoneID);
