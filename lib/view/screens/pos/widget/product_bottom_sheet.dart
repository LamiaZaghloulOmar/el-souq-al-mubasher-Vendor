  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: GetBuilder<PosController>(builder: (posController) {
        ...
        double _discount = (isCampaign || product.restaurantDiscount == 0)
            ? product.discount
            : product.restaurantDiscount;
        String _discountType = (isCampaign || product.restaurantDiscount == 0)
                ...
                Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              Stack(children: [
                                ClipRRect(
                                  ...
                                  child: CustomImage(
                                    image:
                                        '${isCampaign ? Get.find<SplashController>().configModel.baseUrls.campaignImageUrl : Get.find<SplashController>().configModel.baseUrls.productImageUrl}/${product.image}',
                                    ...
                                    itemBuilder: (context, i) {
                                      return InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: posController.variationIndex[
                                                        index] !=
                                                    i
                                                ? Theme.of(context)
                                                    .disabledColor
                        ...
                        (!product.scheduleOrder && !_isAvailable)
                            ? SizedBox()
                            : CustomButton(
