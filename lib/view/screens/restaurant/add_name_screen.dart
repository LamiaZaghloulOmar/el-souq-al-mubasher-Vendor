    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(children: [
          Column(children: [
            Text(_languageList[1].value, style: robotoBold),
            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
            MyTextField(
              hintText: 'food_name'.tr,
              controller: _nameControllerList[1],
              capitalization: TextCapitalization.words,
              focusNode: _nameFocusList[1],
              nextFocus: _descriptionFocusList[1],
            ),
            SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
            MyTextField(
              hintText: 'description'.tr,
              controller: _descriptionControllerList[1],
              focusNode: _descriptionFocusList[1],
              capitalization: TextCapitalization.sentences,
              maxLines: 5,
              inputAction: 1 != _languageList.length - 1
                  ? TextInputAction.next
                  : TextInputAction.done,
              nextFocus:
                  1 != _languageList.length - 1 ? _nameFocusList[1 + 1] : null,
            ),
            SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
          ]),
          ...
          CustomButton(
            ...
            onPressed: () {
              ...
              if (_defaultDataNull) {
                showCustomSnackBar("ادخل اسم ووصف المنتج بالعربية");
              } else {
