...
import 'package:efood_multivendor_restaurant/view/screens/receipt/receipt_preview.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        print('order status: ${orderController.orderDetailsModel}');
                              ...
                              Navigator.push(context,
                                ...
                                return ReceiptPreview(
                                  order: OrderDetails(
                                      totalPaid: _total,
                                      addons: _addOns,
                                      deliveryFee: _deliveryCharge,
                                      discount: _discount,
                                      subTotal: _subTotal,
                                      orderDetailsModel:
                                          orderController.orderDetailsModel,
                                      vatTax: _tax,
                                      totalPrice: _itemsPrice),
                                  orderModel: orderModel,
                                  deliveryMan: orderController.deliveryMan,
                                );
                              }));
                            },
                            child: Text(
...
/*
                                FloatingActionButton(onPressed: () {
                                  print(orderController.orderDetailsModel[0]
                                      .toJson());
                                }),
*/
                                    Row(children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(children: [
                                        ...
                                        /*     Text(
                                          orderController.orderDetailsModel.toList().toString(),
                                          style: robotoMedium.copyWith(
                                              color: Theme.of(context)
                                                  .primaryColor),
                                        ),*/
